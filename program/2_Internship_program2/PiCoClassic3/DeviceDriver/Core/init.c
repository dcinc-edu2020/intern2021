...
/* Function Prototype                                                           */
/*------------------------------------------------------------------------------*/
static void init_clock(void);          // CPUの動作周波数を設定
static void init_io(void);             // IOポート初期化
static void init_cmt(void);            // CMT初期化
static void init_mtu(void);            // MTU設定
static void init_adc(void);            // AD初期化
static void init_sci(void);            // SCI初期化
